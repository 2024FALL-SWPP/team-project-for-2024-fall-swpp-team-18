...
public class GaugeAvalancheController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Transform 체크
        if (playerTransform1 == null || playerTransform3 == null ||startPoint == null || destination == null)
        {
    ...
    void Update()
    {
        ...
        // 현재 거리 계산
        float currentDistance = Vector3.Distance(playerTransform1.position, destination.position);
        ...
        // 현재 거리 계산
        float currentDistance = Vector3.Distance(playerTransform3.position, destination.position);
        float gaugeRatio = 1 - Mathf.Clamp01(currentDistance / totalDistance);
